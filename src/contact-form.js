...
<div>
	...
	<button id="cfbutton" onclick="cfSubmitMessage()" class="form-button color">Send your message</button><a href="https://t.me/Geralt_1999" class="cfpromo">Powered by Dharik</a>
</div>
`;
